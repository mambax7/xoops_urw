 ...
 * _LANGCODE    en
 * _CHARSET     UTF-8
 * @version     $Id: preferences.php 9114 2012-03-08 09:21:58Z tstempko $
 */
...
## URW ##
define("_MD_AM_URW",                      "Url Rewrite");
define("_MD_AM_URW_ISACTIVE",             "Activate url rewrite");
define("_MD_AM_URW_MAXLENGHT",            "Minimum keywords size");
define("_MD_AM_URW_SEPARATOR",            "Operators' separator");
define("_MD_AM_URW_EXT",                  "Extension");
define("_MD_AM_URW_MAX",                  "Max. Keywords");

define("_MD_AM_URW_ISACTIVEDSC",             "");
define("_MD_AM_URW_MAXLENGHTDSC",            "Set 0 to display all the words.");
define("_MD_AM_URW_SEPARATORDSC",            "Available separators: ( | - / , . )");
define("_MD_AM_URW_EXTDSC",                  "* Optional");
define("_MD_AM_URW_MAXDSC",                  "Set 0 to use all the keywords.");
## URW ##
