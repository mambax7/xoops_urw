 ...
 * _LANGCODE    en
 * _CHARSET     UTF-8
 * @version     $Id: preferences.php 1416 2011-03-06 13:34:50Z kris_fr $
 */
...
define("_MD_AM_CHNGUTHEME", "Modifier tous les thèmes des utilisateurs");
...
## URW ##
define("_MD_AM_URW",                      "Réécriture d'url");
define("_MD_AM_URW_ISACTIVE",             "Activer la réécriture d'url");
define("_MD_AM_URW_MAXLENGHT",            "Taille minimum des mots clés");
define("_MD_AM_URW_SEPARATOR",            "Séparateur d'opérateur");
define("_MD_AM_URW_EXT",                  "Extension");
define("_MD_AM_URW_MAX",                  "Max. Keywords");

define("_MD_AM_URW_ISACTIVEDSC",             "");
define("_MD_AM_URW_MAXLENGHTDSC",            "Indiquer 0 pour afficher tous les mots.");
define("_MD_AM_URW_SEPARATORDSC",            "( | - / , . )");
define("_MD_AM_URW_EXTDSC",                  "* Optionnel");
define("_MD_AM_URW_MAXDSC",                  "Set 0 for no limits.");
## URW ##
