...
* @version $Id: makedata.php 8066 2011-11-06 05:09:33Z beckmi $
*/
...
function make_data(&$dbm, $adminname, $adminpass, $adminmail, $language, $gruops)
{
    ...
    $dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by XOOPS &#169; 2001-" . date('Y', time()) . " <a href=\"http://xoops.sourceforge.net\" rel=\"external\" title=\"The XOOPS Project\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
    ...
    ## URW ##
    $dbm->insert('config', " VALUES (135, 0, 8, 'isUrw',          '_MD_AM_URW_ISACTIVE',  '1', '_MD_AM_URW_ISACTIVEDSC',  'yesno',   'int',  0)");
    $dbm->insert('config', " VALUES (136, 0, 8, 'UrwMaxKeyWSize', '_MD_AM_URW_MAXLENGHT', '0', '_MD_AM_URW_MAXLENGHTDSC', 'int',     'int',  1)");
    $dbm->insert('config', " VALUES (137, 0, 8, 'UrwMaxKeyW',     '_MD_AM_URW_MAX',       '0', '_MD_AM_URW_MAXDSC',       'int',     'int',  1)");
    $dbm->insert('config', " VALUES (138, 0, 8, 'UrwSeparator',   '_MD_AM_URW_SEPARATOR', '|', '_MD_AM_URW_SEPARATORDSC', 'textbox', 'text', 3)");
    $dbm->insert('config', " VALUES (139, 0, 8, 'UrwExt',         '_MD_AM_URW_EXT',       'html', '_MD_AM_URW_EXTDSC',    'textbox', 'text', 4)");
    ## URW ##
